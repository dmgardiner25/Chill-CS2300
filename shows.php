...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="content">
        <div class="carousel popular">
            <h1>Popular TV Shows on Chill <?php  
                $result = mysqli_query($link, "SELECT * FROM inventory, tv_show WHERE popular = 1 AND inventory.vid = tv_show.vid ORDER BY RAND()");    
            ...
            <div class="loop owl-carousel">
                <?php
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<div class=\"item\">";
                        echo "<a href=\"watch.php\"><img src=\"images/Flixnet/movie_posters/".$row['picture']."\" onclick=\"send_to_watch(".$row["vid"].")\"></a>";
                        echo "</div>";
                    }
                ?>
            </div>
